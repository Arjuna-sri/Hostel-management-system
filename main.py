...
#cur.execute("insert into hosteld values(20,11,30)")
con.commit()
...
#chilanka
Label(sroot,text="P.S.R Hostel Management System ",font='Timesnewroman 40 ',bg='blue',fg='black').place(x=250,y=10)
...
def mainroot():
	...
	#----------------bottom frame - hostel status and default page-------------------------------------------------------------------------------
	def hotel_status():
		global b_frame
		...
		hts = Label(b_frame,text='Hostel Status',font='msserif 15',fg='black',bg='gray91',height=1)
	#------------inner frames of bottom frame-------------------------
		...
		Label(b_frame,text='Hostel Status',font='msserif 12',bg='cyan4',fg='white').pack(anchor='center')
	...
	def staff():
		...
		Label(emp1inf,text="Ms. Arjuna sri",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Extention : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : arjunasri555@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		...
		Label(emp1inf,text="Warden",bg='white',font='msserif 17 bold').place(x=45,y=0)#pack(side='top')
		Label(emp1inf,text="Ms. Ajitha",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(emp1inf,text="Extention : 032",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(emp1inf,text="Mail : aji0508@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="hostel chef",bg='white',font='msserif 17 bold').place(x=72,y=0)#pack(side='top')
		Label(emp1inf,text="Ms. Triffana",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		Label(emp1inf,text="Extention : 028",bg='white',fg="Grey",font='msserif 10').place(x=72,y=59)
		Label(emp1inf,text="Mail : triffi@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)
		emp1inf.pack_propagate(False)
		...
		Label(emp1inf,text="Ms. Abinaya",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
		Label(emp1inf,text="Extention : 041",bg='white',fg="Grey",font='msserif 10').place(x=55,y=59)
		Label(emp1inf,text="Mail :   abinaya@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)
		emp1inf.pack_propagate(False)
	...
	Label(sl_frame,text='Hostel Status',font='msserif 13',bg='white').place(x=35,y=106)
	Label(sl_frame,text='Rooms',font='msserif 13',bg='white').place(x=248,y=106)
	Label(sl_frame,text='booking',font='msserif 13',bg='white').place(x=417,y=106)
